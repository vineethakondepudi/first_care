 ...
 const handleFilter = () => {
  ...
  return (
    <div className="medical-profile-container">
      ...
      <div className="medical-profile-header">Appointment Requests</div>
...
<Button  type="danger" style={{ backgroundColor: '#34d399', borderColor: '#34d399', marginBottom: 20 }}>End</Button></td>
      </tr>
    ))
  ) : (
    <tr>
